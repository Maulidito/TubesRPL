        ...
        <table class="table text-center mt-4">
            ...
            ?>
                <tr>
                    ...
                    <td><a href="<?= base_url("admin/kursi/$data[id_bis]")?>" class="btn btn-primary btn-success">Kursi</a>&nbsp;<a href="" class="btn btn-warning">Update</a>&nbsp;<a href="" class="btn btn-danger">Delete</a></td>
                </tr>
            <?php 
                $i++;
                endforeach; 
